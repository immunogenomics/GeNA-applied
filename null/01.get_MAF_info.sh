...
# Pull MAF information for all candidate snps used for csaQTL GWAS (already passed MAF 5% threshold) on chr22 
...
# Pull MAF information for all chr22 snps including low-frequency snps (MAF 1% threshold)
