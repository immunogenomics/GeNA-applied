...
print(str(traits.shape[0])+" traits can be defined using clusters in this dataset")
...
# values of k based on a 80% variance explained threshold (larger of two k used in our csaQTL GWAS by default)
