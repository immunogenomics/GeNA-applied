...
# Import published pQTL sumstats from Sun et al, refine to cis windows around lead csaQTL lead snps                                      
# and liftOver published results from GRCh38 to hg19   

# Pull sumstats
cwd=$(pwd)
sumstats_folder="/data/srlab/lrumker/MCSC_Project/cna-qtl/eqtls/sumstats/Sun/"
cd $sumstats_folder
command="wget ftp://ftp.ebi.ac.uk/pub/databases/spot/eQTL/sumstats/QTS000035/QTD000584/QTD000584.all.tsv.gz"
echo $command
eval $command
