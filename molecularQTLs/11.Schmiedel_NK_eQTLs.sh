...
# Import published eQTL sumstats from Schmiedel et al, refine to cis windows around lead csaQTL lead snps
...
cd $sumstats_folder
command="wget ftp://ftp.ebi.ac.uk/pub/databases/spot/eQTL/sumstats/Schmiedel_2018/ge/Schmiedel_2018_ge_NK-cell_naive.all.tsv.gz"
echo $command
eval $command
...
do
    ...
    outfile="${sumstats_folder}${csaQTL_celltype}_${lead_snp}_NK_cis.csv"
...
do
    ...
    infile="${sumstats_folder}${csaQTL_celltype}_${lead_snp}_NK_cis.csv"
    bedfile="${sumstats_folder}${csaQTL_celltype}_${lead_snp}_NK_cis.bed"
    outfile="${sumstats_folder}${csaQTL_celltype}_${lead_snp}_NK_cis.hg19.csv"
    unmapped="${sumstats_folder}${csaQTL_celltype}_${lead_snp}_NK_cis.unmapped"
...
do
    ...
    infile_hg19_pos="${sumstats_folder}${csaQTL_celltype}_${lead_snp}_NK_cis.hg19.csv"
    infile_sumstats="${sumstats_folder}${csaQTL_celltype}_${lead_snp}_NK_cis.csv"
    outfile="${sumstats_folder}${csaQTL_celltype}_${lead_snp}_NK_cis.hg19.renamed.csv"
