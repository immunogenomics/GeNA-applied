...
do
    for celltype in "NK" "B" "Myeloid" "T" "allcells"
    do
	trait_file="${res_folder}traits/${celltype}_${suffix}_traits.txt"
	header_file="${res_folder}vcf_header.txt"
	outfile="${res_folder}sim_genotypes/${celltype}_${suffix}_sim_genotypes.vcf"
	outfile_meta="${res_folder}sim_genotypes/${celltype}_${suffix}_sim_genotypes_meta.tsv"
